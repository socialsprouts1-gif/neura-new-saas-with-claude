...
// exactly who it has already reached. This is what drains that queue.
//
// Drive it the same way as the flow scheduler — a pinger sending
// Authorization: Bearer $CRON_SECRET, or a vercel.json cron on Pro.

export const dynamic = "force-dynamic";

// WhatsApp's default throughput is 80 messages a second, but the ceiling
// that matters here is the serverless invocation. A slice per minute keeps
// each run short and the failure blast radius small.
const BATCH = 60;
